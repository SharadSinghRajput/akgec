...
export const content = {
    "About": `Ajay Kumar Garg Engineering College commenced publication of a biennial Technical Journal in 2010 to disseminate information spanning the entire spectrum of engineering and technology. We envisioned that this activity will help unleash the creative potential of technical community and provide a credible platform to receive professional recognition. Our journey through this arduous path has been a satisfying effort. We have sustained interest and support of the country's Technical community.
...
To recognize the invaluable intellectual contribution made by professionals in advancing the noble cause of dissemination of scientific and engineering knowledge, all published articles since Volume 7 of the "AKGEC International Journal of Technology" are being suitably rewarded. A prize of Rs.5,000 is being paid to the paper adjudged the best for each issue. For the balance, an amount of Rs.2,500 per article is earmarked.`,
        ...
        <div className="grid grid-cols-5">
            ...
            <div className="col-span-3 overflow-y-auto scrollbar-thin">
                <ul className="font-novaReg text-sm space-y-2 h-96 pl-3 leading-4">
                    ...
                    <li>Dr. R.K. Agarwal’s extraordinary inspiring-vision catapulted AKGEC to numero uno position for all time to come. He took the momentous decision in 2010 to launch this biannual publication to nurture creativity and encourage innovations. The journal received manuscripts even from overseas authors, earning accolades from research community worldwide.</li>
                </ul>
            </div>
        </div>
    </>,
    ...
    "Editorial Team": <>
        ...
        <ul className="font-novaReg space-y-3 mt-4">
            ...
            <li>Currently, he is Editor-in-Chief of the <i>‘AKGEC International Journal of Technology’</i>, which is running in ninth volume.</li>
    ...
    "Call for Manuscripts": <>
        <ul className="font-novaReg space-y-3 list-inside">
            ...
            <li>The “AKG International Journal of Technology” i.e. AKGIJT is a peer-reviewed journal published by Ajay Kumar Garg Engineering College (AKGEC). The AKGEC is among the top rung technical institutions situated in the Nationals Capital Region of India in Ghaziabad. The AKGEC is committed to provide world class education and research in the cutting-edge areas and has developed industry scale innovation centres in the frontline technologies. The Institute’s modern infrastructure attracts the industry to supplement training and research. The AKGIJT lives up to the vision of AKGEC and publishes peer review articles in the broad areas of Engineering & Technology involving all major disciplines for the last 13 years. The Journal has so far successfully published 14 biannual volumes and archived all the issues online with free accessibility in pdf format.</li>
                ...
                <table class="min-w-full border border-gray-300">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-2 border-b border-gray-300">Ajay Kumar Garg Engineering College</td>
                        </tr>
                        <tr>
