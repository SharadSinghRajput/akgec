            ...
            <div className="py-8">
                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-3">
                        <div className="bg-blue-900 text-white p-10 w-full h-auto rounded-t-3xl rounded-l-3xl">
                        ...
                        <div className="bg-secondary text-white p-6  w-full h-auto rounded-r-3xl rounded-b-3xl">
                            ...
                            <button className="bg-primary text-white font-bold py-3 px-5 rounded-lg">KNOW MORE →</button>
                        </div>
                    </div>
                </div>
            </div>
