...
const Calendar = ({ currentSemester, setCurrentSemester }) => {
    ...
    return (
        <div className="my-8 lg:max-w-80">
            <h2 className="mb-2 text-[42px] max-2xl:text-3xl max-sm:text-2xl leading-none font-novaReg">Academic Calendar</h2>
            <div className="flex max-[500px]:flex-col lg:flex-col gap-4 max-sm:gap-2">
                <div
                ...
                >
                    <Link href="/academics/academic-calendar"
                        ...
                        className="py-3 text-white uppercase text-[15px] max-sm:text-sm font-novaSemi px-6 text-center"
                    >
                        Odd Semester
                    </Link>
                </div>
                <div
                    ...
                    <Link href="/academics/academic-calendar"
                        className="text-white uppercase text-[15px] max-sm:text-sm font-novaSemi py-3 px-6 text-center">Even Semester
                    </Link>
                </div>
            </div>
        </div>
