...
const slides = [
  {
    id: 1,
    title: "Aerospace",
    description: "Chandigarh University introduces 'CUSAT', North India's premier Student Satellite Designing and Training program, marking its pioneering step in advanced aerospace engineering education."
  },
  {
    id: 2,
    title: "Inauguration",
    description: "Union Defence Minister Rajnath Singh inaugurated the Kalpana Chawla Centre for Research in Space Science and Technology (KCCRST) at Chandigarh University on January 3, 2022."
  },
  {
    id: 3,
    title: "ISRO",
          ...
          <div className="flex justify-end w-full my-auto -mx-4">
            <div className="w-9/12 px-3">
              <div className="max-w-[440px]">
                ...
                <p className="font-novaBold text-lg text-white mb-4 leading-[1.20]">Firmly established as a rapidly rising hub of excellence for innovation and entrepreneurship, Chandigarh University actively nurtures and empowers handpicked creative ideas across diverse fields, transforming them into valuable and viable business opportunities.</p>
                <div className="mb-6 max-w-64">
                  <a className="py-1 px-3 mb-4 mr-4 font-novaBold text-white" href="tbi.php">CU TBI</a>
            ...
            <div className="h-full px-3">
              <div className="max-w-[430px]">
                ...
                <p className="font-novaBold text-lg text-white mb-4 leading-[1.20]">A beacon of innovation & education, CU fosters research, experiential learning, and industry ties for students' future success. With substantial funding, 50 research groups, 30 advanced labs, and numerous patents, CU sets remarkable standards in academia & research.</p>
      ...
      <section className="">
        <div className="max-w-7xl mx-auto h-full flex gap-10">
          <div className="w-[35%] relative bg-blue-600 py-20 flex flex-col gap-5 text-white px-5">
            ...
            <p className="leading-5 font-novaReg">The research landscape at AKGEC University is extensive and impactful. Scholars at the university engage in research across diverse fields, striving to enhance human knowledge through rigorous inquiry, innovation, and insight. AKGEC University is acknowledged by the Department of Scientific and Industrial Research (DSIR) for its contributions to scientific advancement.</p>
            ...
            <div>
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Link href="https://www.youtube.com/embed/NjnVw8Ki7Jw" className="bg-blue-600 hover:bg-blue-700 text-white rounded-full w-12 h-12 flex items-center justify-center transition duration-300">
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="space-y-6 text-center">
            <p className="leading-5">
              Chandigarh University research is strengthened by additional 52 Crore of funded research by the government bodies and corporates.
              ...
              centers within the campus. Chandigarh University Research fraternity includes teaching staff members, scholars, postgraduate and
              ...
              carried out at Chandigarh University Technology Business Incubator.
            </p>
            <p className="leading-5">
              ...
              development. Chandigarh University filed 2400+ Patents, which is second highest number of patent filed by any institution/organization
              in India.
            </p>
          </div>
        </div>
