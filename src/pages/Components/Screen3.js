                        ...
                        >
                            ...
                            >
                                <img
                                    src={item.Logo}
                                    alt="Company Logo"
                                    className="h-12 sm:h-16 max-sm:h-20 max-sm:w-44 bg-white object-contain rounded-lg mb-2"
                                />
            ...
            <div className="flex flex-col justify-center p-5 md:p-10 lg:p-16 bg-BG2 bg-no-repeat bg-cover text-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mt-6">
                    ...
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl font-novaThin mt-4">
                            20 <small className="font-novaLight -ml-1 text-lg">LPA</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Package Offered to 5 Students
                        </p>
                    </div>
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl font-novaThin mt-4">
                            10-20 <small className="font-novaLight -ml-1 text-lg">LPA</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Package Offered to 53 Students
                        </p>
                    </div>
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl font-novaThin mt-4">
                            5-10 <small className="font-novaLight -ml-1 text-lg">LPA</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Package Offered to Approx 306 Students
                        </p>
                    </div>
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl font-novaThin mt-4">
                            5 <small className="font-novaLight -ml-1 text-lg">LPA</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Package Offered to 1042 Students
                        </p>
                    </div>
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl text-orange-300 font-novaThin mt-4">
                            33.80 <small className="font-novaLight text-white -ml-1 text-lg">LPA</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Highest National Package Offered
                        </p>
                    </div>
                    <div className="text-start">
                        <p className="text-2xl md:text-3xl lg:text-5xl text-orange-300 font-novaThin mt-4">
                            1.13 <small className="font-novaLight text-white -ml-1 text-lg">CR</small>
                        </p>
                        <p className="text-sm md:text-base font-novaReg leading-none mt-2">
                            Highest International Package Offered in 2022
                        </p>
                    </div>
                </div>
                ...
                <div className="flex justify-start space-x-4 mt-6 max-lg:justify-center">
                    ...
                    <Button
                        ...
                        className="border border-white text-white text-sm font-novaBold px-4 py-2 rounded-md hover:bg-white hover:text-black"
                    />
                </div>
            </div>
        </div>
