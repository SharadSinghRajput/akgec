...
const Calendar = ({ currentSemester, setCurrentSemester }) => {
    ...
    return (
        <div className="mb-12 lg:max-w-80">
            ...
            <div className="flex max-[500px]:flex-col lg:flex-col gap-4">
                <div
                    ...
                    className={`py-3 flex-1 cursor-pointer text-center rounded-lg ${currentSemester === 'odd' ? 'bg-secondary' : 'bg-secondary'} hover:bg-[#3c5686]`}
                >
                    <Link
                ...
                <div
                    ...
                    className={`py-3 flex-1 text-center cursor-pointer rounded-lg ${currentSemester === 'even' ? 'bg-zinc-900' : 'bg-primary'} hover:bg-[#3c5686]`}
                >
                    <Link
