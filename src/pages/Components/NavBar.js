...
const socialLinks = [
  {
    name : "Facebook",
    svg : <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='lucide lucide-facebook'><path d='M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z'/></svg>
  },
  {
    name : "Instagram",
        ...
        <div className={`md:hidden max-md:col-span-2 ${isScrolled100 ? "hidden" : ""}`}>
          <div className="flex justify-end gap-2 pr-5">
            {socialLinks?.map((item, index)=>(
              <a className="text-xs text-center flex flex-col gap-1 justify-start items-center text-white" href="">
                {item.svg}
