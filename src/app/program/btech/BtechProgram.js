...
const BestEngineeringCollege = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm">
            <h4 className="text-red-600 font-bold">2000+</h4>
            <p className="text-gray-700 text-[13px]">Students Placed (2023-24)</p>
          </div>
          <div className="p-4 border border-gray-200 rounded-lg shadow-sm">
            <h4 className="text-red-600 font-bold">RATED A++</h4>
            <p className="text-gray-700 text-[13px]">The only AKTU engineering college in Uttar Pradesh accredited by NAAC with the highest grade.</p>
          </div>

          <div className="p-4 border border-gray-200 rounded-lg shadow-sm">
            <h4 className="text-red-600 font-bold">19K+</h4>
            <p className="text-gray-700 text-[13px]">Studnents Graduates</p>
          </div>

          <div className="p-4 border border-gray-200 rounded-lg shadow-sm">
            <h4 className="text-red-600 font-bold">5K</h4>
            <p className="text-gray-700 text-[13px]">Students in campus</p>
          </div>
      ...
      <div className="flex flex-wrap lg:flex-nowrap items-start p-4 mt-10 bg-gray-100">
        {/* Left Section: Vision and Mission */}
        <div className="w-full lg:w-1/2 p-4">
          {/* Vision */}
          <h2 className="text-xl font-normal mb-2">Vision</h2>
          <p className="mb-8 text-[13px] text-start text-gray-700 font-medium">
            To be a centre of excellence in providing globally standard education and training in the field of Computer Science & Engineering for producing competent and responsible professionals.
          </p>

          {/* Mission */}
          <h2 className="text-xl font-normal mb-2">Mission</h2>
          <p className="mb-8 text-[13px] text-start text-gray-700 font-medium">
            Our mission is to holistically develop our students into well-rounded professionals who are equipped to excel in the dynamic field of Computer Science & Engineering. We aim to:
          </p>
          <ul className="mb-4 text-[13px] text-start text-gray-700 font-medium">
            <li className="flex mb-2">
              <span className="text-gray-600 mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-arrow-right"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 16 4-4-4-4"/></svg>
              </span>
              <p className="text-[13px] text-start text-gray-700 font-medium">
                Deliver a balanced education combining theory and practical skills to meet industry needs.
              </p>
            </li>
            <li className="flex mb-2">
              <span className="text-gray-600 mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-arrow-right"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 16 4-4-4-4"/></svg>
              ...
              <p className="text-[13px] text-start text-gray-700 font-medium">
                Cultivate innovation, critical thinking, and problem-solving abilities.
              </p>
            </li>
            <li className="flex mb-2">
              <span className="text-gray-600 mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-arrow-right"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 16 4-4-4-4"/></svg>
              ...
              <p className="text-[13px] text-start text-gray-700 font-medium">
                Instill professional responsibility and ethical conduct.
              </p>
            </li>
            <li className="flex mb-2">
              <span className="text-gray-600 mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-arrow-right"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 16 4-4-4-4"/></svg>
              ...
              <p className="text-[13px] text-start text-gray-700 font-medium">
                Promote lifelong learning and continuous development.
              </p>
            </li>
            <li className="flex mb-2">
              <span className="text-gray-600 mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-arrow-right"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="m12 16 4-4-4-4"/></svg>
              ...
              <p className="text-[13px] text-start text-gray-700 font-medium">
                Encourage leadership, teamwork, and interdisciplinary collaboration.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-4">
          <img src="/image/vb.jpg"
            alt="Image related to vision and mission"
...
export default BestEngineeringCollege;
