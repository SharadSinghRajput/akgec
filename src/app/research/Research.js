      ...
      <section className="">
        <div className="max-w-7xl mx-auto h-full flex gap-10">
          <div className="w-[35%] relative bg-blue-600 py-20 flex flex-col gap-5 text-white px-5">
            ...
            <p className="leading-5 font-novaLight ">The research landscape at AKG University is extensive and impactful. Scholars at the university engage in research across diverse fields, striving to enhance human knowledge through rigorous inquiry, innovation, and insight. AKG University is acknowledged by the Department of Scientific and Industrial Research (DSIR) for its contributions to scientific advancement.</p>
