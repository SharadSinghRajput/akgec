...
const Patent = () => {
    ...
    const patentData = [
        ...
        { sno: 2, department: "Information Technology", patents: 42, link: "patent/it-patent" },
        { sno: 3, department: "Electronics & Communication Engineering", patents: 13, link: "patent/ece-patent" },
        { sno: 4, department: "Electrical & Electronics Engineering", patents: 2, link: "patent/en-patent" },
        { sno: 5, department: "Mechanical Engineering", patents: 2, link: "patent/me-patent" },
        { sno: 6, department: "Applied Science & Humanities", patents: 1, link: "patent/ash-patent" },
    ];
