            ...
            <div className="mt-5">
                ...
                <div className="border rounded-lg mb-2">
                    <div className="flex justify-between items-center p-3 cursor-pointer" onClick={() => toggleOption(1)}>
                        <h2 className="text-black font-novaReg text-lg"><strong>OPTION 1 :-</strong> By Road (Bus/Auto-Rickshaw/Taxi)</h2>
                ...
                <div className="border rounded-lg mb-2">
                    <div className="flex justify-between items-center p-3 cursor-pointer" onClick={() => toggleOption(2)}>
                        <h2 className="text-black font-novaReg text-lg"><strong>OPTION 2 :-</strong> By Metro</h2>
                    ...
                    {activeOption === 2 && (
                        <div className="p-3">
                            ...
                            <li className="">Alternatively, you can travel to Ghaziabad Metro Station on the Red Line, then take a cab or shared auto to the college.</li>
                            <div className="mt-4 mb-10 w-1/2 max-sm:w-full">
                ...
                <div className="border rounded-lg mb-2">
                    <div className="flex justify-between items-center p-3 cursor-pointer" onClick={() => toggleOption(3)}>
                        <h2 className="text-black font-novaReg text-lg"><strong>OPTION 3 :-</strong> By Train (Nearest Railway Station)</h2>
                    ...
                    {activeOption === 3 && (
                        <div className="p-3">
                            ...
                            <li className="">Another option is New Delhi Railway Station (NDLS), which is approximately 40 km from the campus. You can take a train to Ghaziabad or a direct cab from New Delhi.</li>
                            <div className="mt-4 mb-10 w-1/2 max-sm:w-full">
                ...
                <div className="border rounded-lg mb-2">
                    <div className="flex justify-between items-center p-3 cursor-pointer" onClick={() => toggleOption(4)}>
                        <h2 className="text-black font-novaReg text-lg"><strong>OPTION 4 :-</strong> By Air</h2>
