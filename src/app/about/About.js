  ...
  return (
    <div className="about-page-container">
      ...
      >
        ...
        {/* Center Box */}
        <motion.div
          className="relative z-10 max-w-7xl mx-auto flex items-center justify-start max-sm:justify-center h-full px-4 max-sm:px-0"
          initial={{ y: 50 }}
          animate={{ y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          <div
            className="bg-white shadow-lg rounded-lg w-[90%] max-w-md h-[600px] flex flex-col items-center justify-center px-10 max-sm:px-6"
            style={{ fontFamily: "Arial, sans-serif" }}
          >
            {/* Heading */}
            <h1
              className="text-3xl max-sm:text-2xl font-novaSemi uppercase tracking-wide text-center mb-4"
            >
              Top University{" "}
            ...
            >
              Ajay Kumar Garg University (AKGU) is a full-fledged University
              affiliated with Dr. A.P.J. Abdul Kalam Technical University (AKTU),
              Lucknow. It is approved by the All India Council for Technical
              Education (AICTE) and recognized for its right to offer undergraduate
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="bg-[#d91f23] hover:bg-blue-700 text-white font-bold text-sm py-3 px-6 rounded focus:outline-none focus:shadow-outline"
            >
              READ MORE
            </motion.button>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col-reverse lg:flex-row lg:items-center lg:justify-evenly w-full min-h-screen px-6 lg:px-20 py-10 gap-10">
          ...
          <motion.div
            className="bg-[#56397d] shadow-md rounded-lg w-full lg:w-[45%] p-6 text-left overflow-hidden"
          ...
          >
            <ul className="list-disc pl-5 text-white text-[13px] space-y-2 text-justify">
              <li>
                AKGU, Ghaziabad, is affiliated with Dr. A.P.J. Abdul Kalam Technical
                University, Lucknow, and approved by the AICTE.
              </li>
              <li>
              ...
              <li>
                ...
                Electronics, Computer Science, Electrical, and Mechanical Engineering,
                along with an MCA program.
              </li>
              <li>
                ...
                College in UPTU for two consecutive years and the Chancellor’s Award
                for the highest B.Tech marks for five consecutive years.
              </li>
              <li>
                The 40-acre campus includes state-of-the-art laboratories,
                classrooms, a central library with over 100,000 books, and computing
                facilities with over 1400 networked computers.
              </li>
              <li>
              ...
              <li>
                ...
                including the Director General, Dr. R.K. Agarwal, with qualifications
                from IIT Kanpur, C.I.T. Cranfield, UK, and IISc Bangalore.
              </li>
              <li>
                AKGU emphasizes industry collaboration, with partnerships for student
                training, consultancy projects, and research in emerging technologies
          ...
          >
            ...
            <p className="text-gray-500 font-novaReg">
              Ajay Kumar Garg University (AKGU), Ghaziabad is affiliated to Dr. A.P.J.
              Abdul Kalam Technical University, Lucknow, and is approved by the All
              India Council for Technical Education. The college was established in
              1998 and offers B.Tech courses in nine disciplines of Engineering
              namely Computer Science and Engineering, Information Technology,
              Computer Science, Computer Science & Information Technology, Computer
              Science and Engineering (Artificial Intelligence & Machine Learning),
              Computer Science and Engineering (Data Science), Computer Science and
              Engineering (Hindi), Artificial Intelligence & Machine Learning,
      ...
      >
        ...
        <div className="relative z-10 flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between w-full min-h-screen px-6 lg:px-20 py-10 gap-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <h1 className="text-4xl sm:text-3xl font-normal tracking-wide mb-6">
              AKG University
            </h1>
            ...
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="bg-[#d91f23] hover:bg-blue-700 text-white font-bold text-sm py-3 px-6 rounded focus:outline-none"
            >
              READ MORE
            </motion.button>
          </motion.div>
        ...
        <div className="lg:flex lg:w-full w-full relative z-10 flex-col lg:flex-row lg:gap-x-10">
          ...
          <div className="lg:w-1/2 w-full flex items-center justify-center relative z-10 p-10 lg:mx-40">
            <div className="bg-white shadow-lg p-8 flex flex-col items-center justify-center">
              <h1 className="text-4xl sm:text-3xl max-sm:text-2xl font-normal text-center mb-10">
                Leading Academic Institution
              </h1>
              <p className="mb-5 text-center text-sm">
                Ajay Kumar Garg University (AKGU) is ranked among the leading and best educational institutions in North India. AKGU consistently ranks among the top university in Uttar Pradesh for its academic excellence, innovative teaching methods, research achievements, and placement records, as recognized by national and international accreditation bodies and media outlets.
              </p>
              <p className="text-center text-sm">
                Ajay Kumar Garg University (AKGU) has established itself as a leader in campus placements. The repeated visits by top-tier multinational companies underscore AKGU's reputation as a premier institution with exceptional placement opportunities in India.
              </p>
        ...
        <div className="lg:flex lg:w-full w-full relative z-10 flex-col lg:flex-row">
          ...
          <div className="lg:w-1/3 w-full flex items-center justify-center relative z-10 p-10 lg:mx-32">
            <div className="bg-white shadow-lg p-8 flex flex-col items-center justify-center">
              ...
              <p className="text-center text-sm mb-5">
                Ajay Kumar Garg University (AKGU) has become an undisputed leader in campus placements. The consistent presence of top-tier companies highlights AKGU's reputation as the 'University with the Best Placements' in India.
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 w-full flex items-center justify-center relative z-10">
            <div className="h-full w-3/4 lg:w-4/5 max-sm:w-full p-6 flex flex-col items-center text-white">
              <h2 className="text-4xl max-sm:text-3xl font-novaReg text-center mb-6">
              ...
              <p className="text-sm text-center">
                ...
                <span className="font-novaBold">1406</span> Placement Offers.
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.section
        className="relative w-full py-20 bg-[#f9fafb]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
