        ...
        <section className='mb-10'>
            ...
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="bg-gray-100 p-8 max-[470px]:p-2 md:border-y max-md:border-l max-md:border-b border-r border-gray-300">
                        <div className="flex items-center mb-2">
                            <Bookmark className="text-blue-600 mr-3 flex-shrink-0" />
                    ...
                    <div className="bg-gray-100 p-8 max-[470px]:p-2 border-x border-b border-gray-300">
                        <div className="flex items-center mb-2">
                            <Bookmark className="text-blue-600 mr-3 flex-shrink-0" />
                    ...
                    <div className="bg-gray-100 p-8 max-[470px]:p-2 border-r max-md:border-l border-b border-gray-300">
                        <div className="flex items-center mb-2">
                            <Bookmark className="text-blue-600 mr-3 flex-shrink-0" />
