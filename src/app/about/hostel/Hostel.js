...
export default function HostelFacility() {
    return (
        ...
        <div className="">
            <div className="">
                <h1 className="text-4xl font-novaReg mb-4 ">Hostels – Home Away from Home</h1>
                <p className="text-gray-700 mb-6 text-sm text-justify">
            ...
            <div className="max-w-7xl mx-auto my-10 p-6">
                <h2 className="text-3xl font-novaSemi text-center mb-8">Facilities at Hostels</h2>
