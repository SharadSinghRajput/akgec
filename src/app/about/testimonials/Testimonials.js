...
const testimonials1 = [
    ...
    },
    {
        ...
        rating: 5,
        college: "Control Academy Bosch Rexroth AG",
    ...
    },
    {
        ...
        rating: 5,
        college: "Mahamaya Technical University, Noida",
        ...
        <section id="testimonials" aria-label="What our customers are saying" className="py-10 sm:py-10">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl md:text-center">
                    <h2 className="text-pretty text-3xl font-novaReg tracking-tighter text-gray-950 data-[dark]:text-white sm:text-6xl">
                        <span className="relative whitespace-nowrap">
                            ...
                            <span className="relative">What people will say !</span>
                        </span>
                    </h2>
                    <p className="mt-6 text-lg font-novaReg tracking-tight text-slate-700">
                        "Discover the experiences and success stories of our students, alumni, and faculty through their own words. In this section, they share their personal journeys, academic growth, and the impact that our institution has had on their lives."
                    </p>
                </div>
                                ...
                                <li key={index}>
                                    <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                                        ...
                                        <blockquote className="relative">
                                            <p className="font-novaReg tracking-tight text-slate-900">
                                                {testimonial.description}
                                            </p>
                                        </blockquote>
                                        <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                                            <div>
                                                <div className="font-novaBold text-base text-slate-900">{testimonial.name}</div>
                                                <div className='text-sm leading-none font-novaReg'>{testimonial.college}</div>
                                                <div className="mt-1 font-novaReg text-sm text-slate-500">{testimonial.designation}</div>
                                            </div>
                                            <div className="overflow-hidden rounded-full bg-slate-50">
                                                <img alt={testimonial.name} loading="lazy" width="56" height="56" decoding="async" className="h-14 w-14 object-cover" src={testimonial.image} />
                                            </div>
                                        </figcaption>
                                    </figure>
                                </li>
