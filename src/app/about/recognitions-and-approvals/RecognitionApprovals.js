                    ...
                    <div className="grid grid-cols-7 w-full gap-3">
                        ...
                        <div className="px-3 col-span-2">
                            ...
                            <div className="flex flex-col">
                                {recognitionsData.map((item) => (<>
                                    ...
                                    <a key={item.id} onClick={() => handleRecognitionClick(item)} className="cursor-pointer -mb-[1px]">
                                        <div className={`flex flex-row mb-10 p-5 bg-[#333333] items-center hover:bg-[#d91f23] hover:text-white ${selectedRecognition === item.id
                        ...
                        <div className="px-3 col-span-5">
                                ...
                                <div className="flex mb-12 -mx-3">
                                    <div className="px-3">
                                        <h3 className="text-2xl font-novaReg">
                                            AKG Joins the Elite 0.1% of Indian Universities with ABET Accreditation in Engineering
                                        </h3>
                            ...
                            <div className="grid grid-cols-7 mt-4 w-full bg-red-600">
                                ...
                                <div className="bg-[#d91f24] col-span-4">
                                    <div className="p-5">
