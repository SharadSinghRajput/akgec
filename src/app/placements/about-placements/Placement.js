    ...
    <>
      ...
      <section className="pt-16 h-fit">
        <div className="relative px-3 space-x-10">
          ...
          <button
            onClick={nextSlide}
            className="absolute right-10 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-md"
      ...
      <section className="relative bg-BG10 h-[80vh] py-24 -mt-[72px]">
        <div className="absolute inset-0 bg-[#011a6c] opacity-50"></div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mt-8">
              <div className="relative w-[800px] h-[450px] bg-white rounded-lg overflow-hidden shadow-lg">
                <img src="/image/video-thumbnail.jpeg" alt="thumbnail" className="w-full h-full object-cover" />
        ...
        <div className='px-3 max-w-7xl mx-auto'>
          <div className='flex'>
            <div className='flex-1'>
              <img
                src="/image/Director_AKGEC-place.webp"
                alt="Vice President"
            ...
            <div className='relative p-10 bg-[#f3f3f3] flex-1 flex flex-col rounded-tr-lg rounded-br-lg overflow-hidden'>
              ...
              <p className='mb-[15px]'>
                <strong className='text-lg font-novaSemi pr-3 border-r-2 border-r-[#f7a600] mr-2'>Director</strong> AKGEC University
              </p>
      ...
      <section className='bg-BG11 min-h-screen bg-cover bg-no-repeat cursor-pointer'>
          ...
          <div className="relative grid grid-cols-1 overflow-hidden pt-20 h-[570px]">
            <AnimatePresence initial={false} custom={direction}>
              <motion.div
                ...
                animate="visible"
                exit="exit"
                className="flex gap-4 col-span-1"
              >
                {testimonials.slice(currentIndex, currentIndex + 3).map((testimonial, index) => (
                  <div key={index} className="bg-[#f3f3f3] p-10 rounded-lg shadow-lg text-center w-1/3 flex flex-col justify-top -top-10 items-center">
                    <img
                      src={testimonial.image}
                      alt={testimonial.name}
                      className="w-28 h-28 rounded-full mb-4"
                    />
                    <h3 className="text-lg font-semibold mb-2.5">{testimonial.name}</h3>
                    <h5 className="text-gray-600 text-base">{testimonial.company}</h5>
                    <span className="mb-4 text-lg font-novaBold text-gray-800">
                      "{testimonial.quote}"
                    </span>
                    <p className="text-sm font-novaReg mb-4 text-gray-800">{testimonial.desc}</p>
                  </div>
                ))}
              </motion.div>
            </AnimatePresence>
            ...
            <div className='px-3'>
              <div className='flex justify-between'>
                <div className='text-start w-full'>
                  ...
                  <ul className='mb-4'>
                    <li className="relative cursor-pointer font-novaReg text-sm mb-4 pl-8 before:content-[''] before:absolute before:left-0 before:top-1/2 before:w-4 before:h-4 before:bg-no-repeat before:bg-contain before:bg-[url('/image/link-arrow.png')] before:-translate-y-1/2">
