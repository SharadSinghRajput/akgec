        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className='mt-2 font-novaReg'>According to the Global Tech Insights report, the demand for software developers is expected to increase by 22% from 2021 to 2031, driven by the growing need for innovative software solutions across industries.</p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-2xl font-novaReg text-gray-800 mb-2">
              AKG University B.Tech CSE Admission Eligibility & Fees
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-white font-novaReg leading-relaxed">
                The expanding IT industry in India offers numerous opportunities for fresh Computer Science graduates. Beyond the IT sector, Computer Engineers can explore roles in design, development, manufacturing, and maintenance across various industries. Careers as programmers, web developers, e-commerce experts, and roles in aerospace, telecommunications, and automotive sectors offer promising career paths and competitive salaries.
              </p>
            </div>
