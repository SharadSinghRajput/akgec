...
const offlineFirstSteps = [
    {
        main: "Admission Office, Chandigarh University, SCO 223, First Floor, Sector 36 D, Chandigarh, 160036"
    },
    {
...
const offlineSecondSteps = [
    {
        main: "Submit the admission form and receive prospectus on payment of Rs 1000/- from Chandigarh University Campus or any local Admission Office of the University."
    },
];
...
export const HowToApply = () => {
    ...
    return (
        <div className="px-3">
            <h1 className="text-2xl md:text-4xl font-novaReg mb-2.5 w-full">Chandigarh University Admissions 2024</h1>
            <h3 className="text-xl md:text-[32px] font-novaReg mb-8 w-full">How to Apply Chandigarh University Admissions 2024</h3>
