...
export default function PageDetailsForm({ parentPage, title, pageType }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-6 my-10 bg-white shadow-lg rounded-lg">
