                ...
                {hostels.map((hostel, index) => (
                    <div key={index} className="bg-white flex flex-col justify-between shadow-md transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        <img
                            src={hostel.img}
                            alt={hostel.title}
                            className="w-full h-48 object-cover object-center mb-6 max-md:mb-3 max-sm:mb-3"
                        />
                        <div className="px-4 max-sm:px-2.5">
                            <h2 className="text-lg font-semibold mb-2 hover:text-red-500 max-sm:text-base">{hostel.title}</h2>
                            <div className="w-24 h-1 bg-red-300 mb-2 max-sm:mb-1.5"></div>
                        </div>
