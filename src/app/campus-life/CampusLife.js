                ...
                <AnimatePresence initial={false} custom={currentSlide}>
                    ...
                    >
                        <div className="relative w-full h-full">
                            ...
                            <div className="absolute inset-0 max-w-7xl mx-auto flex items-center justify-between px-4 text-white">
                                <div className="">
                                    <h2 className="text-6xl uppercase font-novaBold mb-4 max-w-sm leading-none">{slides[currentSlide].title} <span className="text-secondary">{slides[currentSlide].subHeading}</span></h2>
                                ...
                                <div className=" flex flex-col items-start">
                                    ...
                                    <button className="py-2.5 px-6 rounded-xl bg-secondary text-black font-novaBold tracking-wider text-sm hover:bg-orange-600 flex items-center gap-2">
