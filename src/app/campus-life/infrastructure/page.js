  ...
  return (
    <>
      <div className="bg-[#f2f6ff]">
        <Header title={"AKG University Infrastructures"} bg="/image/building/building4.webp" Button={{ name: "Apply Now", Link: "/" }} gradient={"bg-gradient-to-r from-zinc-900 to-gray-900/40"} />
