            ...
            <div className="bg-gray-200">
                <div className="bg-PaperBackground ">
                    <div className="bg-white/80">
                        <Header title={"Innovative facilities designed for curious thinkers"} bg="/image/building/building2.webp" gradient={"bg-gradient-to-r from-gray-900 to-gray-900/40"} />
