...
const FacilityCard = ({ title, image, description }) => (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4 max-sm:p-3">
            <h3 className="text-lg leading-5 font-novaSemi mb-2 max-sm:text-base">{title}</h3>
    ...
    return (
        <div className="px-2 py-4 max-sm:py-3">
            <div className="mb-8">
                ...
                <p className="text-base my-4 font-novaReg max-sm:text-sm max-sm:my-3">
                ...
                <h6 className="mt-2 text-sm font-novaSemi text-blue-600">
