    ...
    <>
      <div className="px-4 max-sm:px-3">
        ...
        <div className="space-y-4 mb-8 max-sm:mb-4 max-sm:space-y-2">
          <p className="text-base text-gray-900 font-novaReg max-sm:text-sm">
        ...
        {auditoriumData?.map((auditorium) => (
          <div key={auditorium.name} className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4 max-md:p-3 max-sm:p-2.5">
              ...
              <div className="w-16 h-0.5 bg-red-500 mb-4 max-sm:mb-2"></div>
              <p className="text-base text-gray-600 font-novaReg max-sm:text-sm">{auditorium.description}</p>
            </div>
          </div>
        ))}
      </div>
