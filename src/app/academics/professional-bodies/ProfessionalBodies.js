    ...
    return (
        <>
            ...
            <section className="max-w-7xl mx-auto text-center py-16 max-sm:py-10">
                ...
                <p className="mt-2 text-2xl max-md:text-xl px-2 max-sm:text-base font-novaLight max-w-4xl mx-auto">
                    They can comprise <strong>student and professional members</strong> who come together to understand how to comprehend solutions to real-world problems. These bodies help in empowering people through the power of knowledge and organise lessons revolving around <strong>value-added courses</strong>, and various kinds of learning series and competitions.
                </p>
            </section>
            <section className="relative bg-BG17 bg-cover bg-center">
                ...
                <div className="relative max-w-7xl mx-auto py-32 px-6">
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-novaBold max-w-lg mb-6 text-white leading-none">Why are these Professional Bodies important?</h1>
                    <p className="text-[15px] max-sm:text-sm max-w-lg text-white text-justify">
            ...
            <section className="relative bg-BG13 bg-cover min-h-screen" id="industry-partner">
                ...
                <div className="absolute inset-0 max-w-[1300px] mx-auto flex justify-end max-lg:justify-center">
                    <div className="p-10 max-lg:p-0">
                        <div className="container mx-auto px-4 py-10 max-lg:py-8 max-md:py-6 max-sm:py-4">
                            ...
                            <table className=" bg-white border border-gray-300">
                                <thead>
                                    <tr className="bg-[#333643]">
                                        <th className="px-6 py-2 text-left text-sm font-novaSemi max-sm:text-xs text-white uppercase">NAME OF PROFESSIONAL BODY</th>
                                        <th className="px-6 max-sm:px-0 py-2 text-left text-sm font-novaSemi max-sm:text-xs text-white uppercase">NO. OF MEMBERS</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white border border-gray-500 divide-gray-200">
                                    {data?.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="px-6 max-sm:px-2 py-4 whitespace-nowrap text-sm max-sm:text-xs text-center border border-gray-500 text-gray-500">{item.members}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
