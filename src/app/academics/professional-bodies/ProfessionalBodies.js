...
function ProfessionalBodies() {
    return (
        <>
            <section className='relative bg-BG12 bg-fixed bg-top bg-cover h-[85vh] max-sm:h-[70vh]'>
            ...
            <section className='max-w-7xl mx-auto text-center py-20 max-sm:py-10'>
            ...
            <section className='relative bg-BG11 bg-cover bg-center'>
                ...
                <div className='relative max-w-7xl mx-auto py-32 px-6'>
                    <h1 className="text-2xl md:text-3xl lg:text-4xl font-novaBold max-w-sm mb-6 text-white leading-none">
                        Why are these Professional Bodies important?
                    </h1>
                    <p className="text-[15px] max-sm:text-sm max-w-lg text-white">
