    ...
    return (
        <div className="container mx-auto p-4 max-sm:p-1">
            ...
            <p className="mt-4 mb-5 text-lg font-novaLight leading-6 text-justify max-lg:text-base max-md:text-base max-sm:text-xs">
                ...
                <br />
                <br />
                AKG University has gained esteemed recognition for its dedication to educational excellence. Accredited by the National Accreditation Board, it is among the select private engineering colleges in the region to achieve this status. The institution’s commitment to upholding high academic standards distinguishes it as a frontrunner in engineering education.
                <br />
                <br />
