    ...
    return (
        <div className="bg-white py-8">
            <div className="">
                ...
                <div className='max-w-7xl mx-auto relative z-10 px-24   '>
                    <div className="lg:col-span-4 lg:row-end-1 relative">
                        ...
                        <div className="absolute max-lg:relative max-lg:bg-white max-lg:rounded-none inset-0 pb-8 pl-10 flex flex-col items-start justify-end bg-black bg-opacity-50 rounded-lg p-4">
                            <h2 className="text-white max-lg:text-gray-800 text-lg md:text-2xl lg:text-3xl font-light mb-2 w-1/6">
                                World-Class Campus
                            </h2>
                            <p className="text-white w-1/2 max-lg:text-gray-800 text-sm md:text-base lg:text-base font-light mb-2 ">
                ...
                <div className='bg-BG3 h-[800px] w-full flex flex-col justify-end pb-28 -mt-36 max-lg:-mt-20 max-lg:pt-16 px-40 pt-10 '>
                    <div className='max-w-[1600px] mx-auto max-lg:p-10'>
                        <div className='grid grid-cols-3 '>
                            <div className='col-span-2 max-lg:col-span-3'>
                                ...
                                <p className='text-white text-2xl leading-none font-novaLight'>At Ajay Kumar Garg Engineering College, we empower students to aim high—whether it's advancing in engineering research, launching successful startups, excelling in competitive exams, or pursuing a global career. We inspire dreams and nurture leaders for tomorrow's challenges.</p>
                            </div>
