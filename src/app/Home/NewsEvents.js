...
export default function NewsEvents() {
    return (
        <div className="bg-gray-100/50 py-10">
            <h2 className="text-4xl font-extralight text-center text-gray-700">
                Spotlight of Success
            </h2>
            <p className="text-xl font-extralight text-center max-w-screen-lg mx-auto text-gray-700">
            ...
            <div className="mx-auto max-w-7xl py-10">
                <div className="grid grid-cols-2 max-lg:grid-cols-1">
                    <div className="col-span-1 rounded-lg mr-5 border border-gray-200 hover:shadow-lg">
                        <img
                            alt=""
                        ...
                        />
                        <div className="p-8">
                            <h2 className="text-xl font-light">Foundation Stone Laying Ceremony by Hon’ble Chief Minister
                            </h2>
                            <p className="text-sm font-light text-gray-700 text-justify mt-5">
                            ...
                            <button type="button" className="text-sm font-bold mt-5" >
                                Read More
                            </button>
                        </div>
                    </div>
