      ...
      <section className='max-w-7xl mx-auto px-5 max-sm:px-2 py-10'>
        <div>
          <div className='flex justify-between'>
            <h2 className='font-novaReg text-4xl'>School of Engineering and Technology</h2>
            <button className='px-6 py-2 text-sm bg-black text-white font-novaSemi uppercase tracking-wider rounded-full hover:bg-gray-300 hover:text-black hover:border border-gray-300 transition duration-200 ease-linear flex items-center gap-2'>
